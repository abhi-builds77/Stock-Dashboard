...
def create_dashboard_figure(stock_data: pd.DataFrame, revenue_data: pd.DataFrame, title: str):
    ...
    fig.update_yaxes(title_text="Stock Price", gridcolor="#1e293b", fixedrange=False, row=1, col=1, secondary_y=False)
    fig.update_yaxes(title_text="Revenue (M)", showgrid=False, fixedrange=False, row=1, col=1, secondary_y=True)
    fig.update_yaxes(title_text="Volume", gridcolor="#1e293b", fixedrange=False, row=2, col=1)
